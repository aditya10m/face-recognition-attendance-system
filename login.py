...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"D:\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\loginBg1.jpg")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            mycursor.execute("select * from student where email=%s and pwd=%s",(
                self.txtuser.get(),
                self.txtpwd.get()
            ))
...
#=======================Reset Passowrd Function=============================
    def reset_pass(self):
        if self.var_ssq.get()=="Select":
            ...
            conn = mysql.connector.connect(username='root', password='Aditya@123',host='localhost',database='face_recognizer1',port=3306)
            mycursor = conn.cursor()
            query=("select * from student where email=%s and ss_que=%s and s_ans=%s")
            ...
            if row==None:
                ...
                query=("update student set pwd=%s where email=%s")
...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"D:\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\banner.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"D:\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"D:\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\qr1.png")
